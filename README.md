<picture>
  ...
  <img
    ...
    alt="Ron Finn — scientific data strategy, computational biology, software engineering and data governance"
    width="100%"
  >
</picture>
...
<picture>
  ...
  <img
    src="./assets/capability-map-light.svg"
    alt="Capability map covering scientific computing, engineering, data platforms and governance"
    width="100%"
  >
</picture>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><code>synthetic-data</code> <code>data-governance</code> <code>AI agents</code></p>
    </td>
    <td width="50%" valign="top">
      <h3>
      ...
      <p><code>anndata</code> <code>phenotypic-profiling</code> <code>validation</code></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
...
<picture>
  ...
  <img
    src="./assets/profile-stats-light.svg"
    alt="Automatically generated GitHub portfolio metrics"
    width="100%"
  >
</picture>
...
<picture>
  ...
  <img
    src="./assets/activity-light.svg"
    alt="Automatically generated twelve-month GitHub contribution activity"
    width="100%"
  >
</picture>
